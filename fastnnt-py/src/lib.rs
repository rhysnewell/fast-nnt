...
#[pyfunction]
#[pyo3(signature = (x, max_iterations=5000, ordering_method=None, inference_method=None, labels=None, canonical_presort=false))]
fn run_neighbour_net<'py>(
    ...
    args.canonical_presort = canonical_presort;
...
fn run_neighbor_net<'py>(
    ...
    run_neighbour_net(_py, x, max_iterations, ordering_method, inference_method, labels, canonical_presort)
}
